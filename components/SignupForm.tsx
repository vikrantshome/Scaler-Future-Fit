  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 md:p-8">
      <div className="bg-white w-full max-w-5xl rounded-3xl shadow-2xl overflow-hidden border border-slate-100 flex flex-col md:flex-row">
        ...
        <div className="md:w-5/12 bg-slate-900 text-white p-8 relative overflow-hidden flex flex-col">
            {/* Abstract Background */}
            ...
            <div className="relative z-10 flex flex-col h-full">
                ...
                {topResult ? (
                    <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 mb-8 transform transition-transform hover:scale-[1.02]">
                         <div className="flex items-start justify-between mb-4">
                             ...
                             <div className="bg-green-500 text-white text-xs font-bold px-2 py-1 rounded flex items-center shadow-lg">
                ...
                <div className="mt-auto relative">
                    ...
                    <div className="space-y-3 opacity-60 filter blur-[1px] select-none pointer-events-none">
